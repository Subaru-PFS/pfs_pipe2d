...
@export
class FiberNormsSource(CalibSource, typeName="fiberNorms", commandName="constructFiberNorms.py"):
    pass
...
class CalibBlock:
    ...
    calibTypes = ["bias", "dark", "flat", "bootstrap", "fiberProfiles", "detectorMap", "fiberNorms"]
